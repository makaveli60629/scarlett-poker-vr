// /js/main.js — Scarlett VR Poker — MASTER MAIN
...
camera.position.set(0, 1.6, 3.25);

// ---------- World ----------
const world = initWorld({ THREE, scene, log });

// ---------- VRButton (uses your index session init w/ hand-tracking) ----------
...
// ---------- Controllers (hidden permanently) ----------
...
function placePlayerAtSpawn() {
  const spawn = (world.spawn || new THREE.Vector3(0, 0, 3.25)).clone();
...
renderer.setAnimationLoop((t, frame) => {
  ...
  // --- Movement input (robust, no handedness dependency) ---
