...
export function initControls({ renderer, scene, camera, playerGroup, world, ui, onTeleport }) {
  ...
  function updateVRAim() {
    // Wrist hover (UI decides hover state)
