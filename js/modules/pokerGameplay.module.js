...
// Deterministic demo loop + pause/step/speed + pot/vacuum (FULL)
...
export default {
  ...
  async init({ THREE, anchors, tableData, log }) {
    ...
    this._rt = { S, seatCount, tableData,
      ...
      hideAllCards, showHoleCards, showFlop, showTurn, showRiver,
      sfx, advanceDealer, pushToPot, vacuumToSeat
    };
