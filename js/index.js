// /js/scarlett1/index.js — SCARLETT1 PRIME ENTRY (FULL • HARD SAFE)
// BUILD: SCARLETT1_INDEX_FULL_SAFE_v4_3

const BUILD = "SCARLETT1_INDEX_FULL_SAFE_v4_3";
...
// Controller objects (no model factory; we make our own rays)
const controllers = {
  left: null,
  right: null,
  leftGamepad: null,
...
async function boot() {
  ...
  setStatus(
    `ready ✅\nBUILD=${BUILD}\nTeleport: ${teleportEnabled ? "ON" : "OFF"}\nEnter VR button works (no VRButton dependency)`
  );
}
