...
import { handleWin } from './poker-logic.js';

// --- SCENE SETUP ---
const scene = new THREE.Scene();
scene.background = new THREE.Color(0x050505); // Dark grey so you can see depth
...
const tableLight = new THREE.PointLight(0x00F0FF, 2, 10);
